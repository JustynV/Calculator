...
class AuthenticationDatatasource {
  Future<String> login(String baseUrl, String email, String password) async {
    ...
    if (response.statusCode == 200) {
      ...
      logError("Got error coderrrr ${response.statusCode}");
      return Future.error('Error codrrrrre ${response.statusCode}');
    }
  }
  ...
  Future<bool> signUp(String baseUrl, String email, String password) async {
    ...
    if (response.statusCode == 200) {
      ...
      logError("Got error codeeeeee ${response.statusCode}");
      return Future.error('Error codeeee ${response.statusCode}');
    }
  }
